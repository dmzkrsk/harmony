...
class ChordLength(object):
    ...
    def __add__(self, other):
        ...
        return ChordLength(self.rc(d) + odc, d)
    ...
    def shortage(self, other):
        ...
        if n1:
            return ChordLength(n2 - n1, d)
        else:
            return ChordLength(0, 1)
